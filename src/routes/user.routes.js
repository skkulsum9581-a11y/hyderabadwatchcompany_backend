...
import { emailRegisteration, forgotPassword, isLoggedIn, loginUser, logoutUser, otp, otpVerify, refreshAccessToken, registerUser, updateAddress, updateAvatar, updateEmail, updateName, updatePassword, updatePhoneNumber } from '../controllers/user.controller.js'
